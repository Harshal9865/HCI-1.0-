    ...
    <div className="h-screen flex flex-col lg:flex-row">
      ...
      <aside className="w-full lg:w-64 bg-gradient-to-r from-teal-500 to-emerald-400 text-white p-6 shadow-md lg:min-h-screen">
        ...
        <nav className="space-y-4">
          <a href="/profile" className="block text-lg py-3 px-4 bg-white text-teal-600 rounded-lg shadow-md hover:bg-teal-100 hover:scale-105 transition duration-200">
            Profile
          </a>
          <a href="/attendance" className="block text-lg py-3 px-4 bg-white text-teal-600 rounded-lg shadow-md hover:bg-teal-100 hover:scale-105 transition duration-200">
            Attendance
          </a>
          <a href="/payroll" className="block text-lg py-3 px-4 bg-white text-teal-600 rounded-lg shadow-md hover:bg-teal-100 hover:scale-105 transition duration-200">
            Payroll
          </a>
        </nav>
      </aside>
      ...
      {/* Main Content */}
      <main className="flex-1 bg-gradient-to-r from-gray-100 to-white p-6 lg:p-8">
