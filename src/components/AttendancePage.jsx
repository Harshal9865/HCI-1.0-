  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-full mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-4xl font-bold mb-6 text-center text-teal-600">Attendance Overview</h1>

        <div className="flex flex-col gap-8 md:flex-row md:gap-10 w-full">
          {/* Calendar Section */}
          <div className="w-full md:w-[45%] bg-gray-50 p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold mb-4 text-center text-teal-600">Attendance Calendar</h2>
            ...
            <button
              ...
              className="mt-4 w-full py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition duration-200"
            >
              Today
            </button>
            <button
              onClick={markAttendance}
              className="mt-4 w-full py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200"
            >
              Mark Present
            </button>
          </div>
          ...
          <div className="w-full md:w-[45%] bg-gray-50 p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold mb-4 text-center text-teal-600">Attendance History</h2>
                  ...
                  {attendanceData.map((item, index) => (
                    <tr key={index} className="border-b">
                      ...
                      <td className="px-4 py-2 text-center">
                        <button className="bg-green-600 text-white py-1 px-3 rounded-lg hover:bg-green-700 transition duration-200">View</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
          ...
          <div className="w-full md:w-[45%] bg-gray-50 p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold mb-4 text-center text-teal-600">Upcoming Events & Holidays</h2>
